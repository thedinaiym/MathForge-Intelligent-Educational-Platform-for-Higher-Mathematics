...
class SiteRating(Base):
    """One-per-user satisfaction rating (1–5 stars) collected after first login."""
    ...
    __table_args__ = (
        CheckConstraint("score >= 1 AND score <= 5", name="ck_site_rating_score"),
        UniqueConstraint("user_id", name="uq_site_rating_user"),
    )

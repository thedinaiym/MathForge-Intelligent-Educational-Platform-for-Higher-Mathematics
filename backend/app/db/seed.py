...
TEMPLATES = [
    ...
    },
    {
        ...
        "template_json": {
            ...
            "constraints": [],
            "texts": {
                "en": "Find f({P}) for f(x) = {A}x² + {B}x",
                "ru": "Найдите f({P}) для f(x) = {A}x² + {B}x",
                "kg": "f(x) = {A}x² + {B}x үчүн f({P}) табыңыз",
            },
        },
        "is_active": True,
    },
    {
        ...
        "template_json": {
            ...
            "texts": {
                "en": "Compute ∫₀^{B} {A}x dx",
                "ru": "Вычислите ∫₀^{B} {A}x dx",
                "kg": "∫₀^{B} {A}x dx эсептеңиз",
            },
        },
        "is_active": True,
    },
    {
        ...
        "template_json": {
            ...
            "constraints": [],
            "texts": {
                "en": "Find the discriminant of {A}x² + {B}x + {C}",
                "ru": "Найдите дискриминант {A}x² + {B}x + {C}",
                "kg": "{A}x² + {B}x + {C} дискриминантын табыңыз",
            },
        },
        "is_active": True,
    },
    ...
    },
    {
        ...
        "template_json": {
            ...
            "constraints": ["A != 0"],
            "texts": {
                "en": "Find the critical points of f(x) = {A}x³ - {B}x²",
                "ru": "Найдите критические точки f(x) = {A}x³ - {B}x²",
                "kg": "f(x) = {A}x³ - {B}x² критикалык чекиттерин табыңыз",
            },
        },
        "is_active": True,
    },
    {
        ...
        "template_json": {
            ...
            "constraints": [],
            "texts": {
                "en": "Evaluate f({P}) for f(x) = {A}x³ + {B}x² + {C}x",
                "ru": "Вычислите f({P}) для f(x) = {A}x³ + {B}x² + {C}x",
                "kg": "f(x) = {A}x³ + {B}x² + {C}x үчүн f({P}) табыңыз",
            },
        },
        "is_active": True,
    },
    ...
    # ── hard ───────────────────────────────────────────────────────────────
    {
        ...
        "template_json": {
            ...
            "texts": {
                "en": "Solve: {A}x⁴ = {B}x²",
                "ru": "Решите уравнение: {A}x⁴ = {B}x²",
                "kg": "Теңдемени чечиңиз: {A}x⁴ = {B}x²",
            },
        },
        "is_active": True,
    },
    {
        ...
        "template_json": {
            ...
            "constraints": [],
            "texts": {
                "en": "Find f(g({P})) where f(x) = {A}x², g(x) = {B}x + {C}",
                "ru": "Найдите f(g({P})), где f(x) = {A}x², g(x) = {B}x + {C}",
                "kg": "f(g({P})) табыңыз, мында f(x) = {A}x², g(x) = {B}x + {C}",
            },
        },
        "is_active": True,
    },
    ...
    },
    {
        ...
        "template_json": {
            ...
            "constraints": [],
            "texts": {
                "en": "Find |v|² for v = ({A}, {B}, {C})",
                "ru": "Найдите |v|² для v = ({A}, {B}, {C})",
                "kg": "v = ({A}, {B}, {C}) үчүн |v|² табыңыз",
            },
        },
        "is_active": True,
    },
    ...
    },
    {
        ...
        "template_json": {
            ...
            "constraints": [],
            "texts": {
                "en": "Find tr(M²) for M = [[{A},{B}],[{C},{D}]]",
                "ru": "Найдите tr(M²) для M = [[{A},{B}],[{C},{D}]]",
                "kg": "M = [[{A},{B}],[{C},{D}]] үчүн tr(M²) табыңыз",
            },
        },
        "is_active": True,
    },
    ...
    },
    {
        ...
        "template_json": {
            ...
            "constraints": [],
            "texts": {
                "en": "Find the sum of the first {N} terms of AP: a₁ = {A}, d = {D}",
                "ru": "Найдите сумму первых {N} членов АП: a₁ = {A}, d = {D}",
                "kg": "АП нын биринчи {N} мүчөсүнүн суммасын табыңыз: a₁ = {A}, d = {D}",
            },
        },
        "is_active": True,
    },
